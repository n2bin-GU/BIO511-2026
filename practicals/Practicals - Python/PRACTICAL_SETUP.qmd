...
If you think there is a lot of new syntax, don't worry. We will begin explaining the python syntax from the ground up starting tomorrow.
...
Create a github repo for this course. Name it `BIO511_python_2026_<My-Name>`. Create a folder for the first assignment in your new git repo and push your solutions for the next exercise below. This should allow you to easily show the rest of the group what you did tomorrow.
...
```
Create a subdirectory in the one you just created
```python
...
```
Finally, we will combine what we’ve gone through so far. Create a script with an input argument that is a path to one of your files. Make the script print the basename of the file.
