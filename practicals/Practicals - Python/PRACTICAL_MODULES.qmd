...
You will be given two scripts (see below), where the main.py will import all functions from a separate script premade_script.py which first parses a fasta-file into codons, and then translates these to amino acids. You will also need a FASTA file to run the scripts on, which you can find on Canvas.
...
def main():
    ...
    # Here the students will need to call the exercise_function from premade_script.py
